package com.example.auth_client_starter.constants;

public class SecurityConstants {
    public static final String CLIENT_ID = "client_id";
    public static final String ACCOUNT_TYPE_PARAM_NAME = "account_type";
     ...
     * 默认的处理验证码的url前缀
     */
    public static String DEFAULT_VALIDATE_CODE_URL_PREFIX = "/validata/code";
